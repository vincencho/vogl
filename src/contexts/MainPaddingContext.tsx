...
const MainPaddingContext = createContext<MainPaddingContextType | undefined>(undefined);

export const MainPaddingProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
